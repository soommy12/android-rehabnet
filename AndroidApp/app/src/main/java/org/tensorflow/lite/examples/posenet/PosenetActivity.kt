...
import pl.gnacek.rehabnet.Rehabnet
...
class PosenetActivity :
  ...
  /** An object for the Rehabnet library.    */
  private lateinit var rehabnet: Rehabnet
  ...
  private var probabilityTextView: TextView? = null
  ...
  private val exerciseTimer = object : CountDownTimer(12000, 1000) {
  ...
  private fun processExercise() {
    ...
    rehabnet.estimateExercise()
  }

  private val readySteadyTimer = object : CountDownTimer(3000, 1000) {
    var startNumber = 4
    override fun onTick(millisUntilFinished: Long) {
      countDownTextView?.text = (--startNumber).toString()
    }
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    probabilityTextView = view.findViewById(R.id.probability)
  ...
  override fun onStart() {
    ...
    rehabnet = Rehabnet(this.context!!)
  }
...
//    println("****** START___frameKeyPoints ********")
//    for(keyPoint in person.keyPoints) {
//      print(keyPoint.bodyPart.name + "\t" + "X ${keyPoint.position.x}\tY ${keyPoint.position.y}\n")
//    }
//    println("****** EMD ***************************")
    draw(canvas, person, scaledBitmap)
    if(shouldRecordFrames) rehabnet.saveFrame(person)
//    val exercise = rehabnet.estimateExerciseForFrame(person)
//    println("EXCERCISE:... ${exercise.first} with prob: ${exercise.second}")
//    activity?.runOnUiThread {
//      this.exerciseNameTextView?.text = exercise.first
//      this.probabilityTextView?.text = exercise.second.toString()
//    }
  }
